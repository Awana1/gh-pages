...
$(function() {
    $(window).on("scroll", function() {
        if($(window).scrollTop() > 50) {
            ...
            document.getElementById("logoHeader").src = "https://github.com/Awana1/gh-pages/blob/master/img/logo_header.png";
           ...
           document.getElementById("logoHeader").src = "https://github.com/Awana1/gh-pages/blob/master/img/logo_header2.png";
